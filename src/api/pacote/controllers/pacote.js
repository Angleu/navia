...
// module.exports = createCoreController('api::pacote.pacote');

module.exports = createCoreController('api::pacote.pacote', ({ strapi }) => ({
  ...
  async find(ctx) {
    ...
    const customers = await strapi.db.query('api::pacote.pacote').findMany({
  ...
  async create(ctx) {
    ...
    const entity = await strapi.db.query('api::pacote.pacote').create({ data });
